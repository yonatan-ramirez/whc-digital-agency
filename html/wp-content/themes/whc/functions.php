...
function whc_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar2', 'whc' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add random stuff, stuff.', 'whc' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_post_type('fourth', $fourthArgs);
...
register_post_type('fith', $fithArgs);
...
register_post_type('six', $sixArgs);
...
register_post_type('seven', $sevenArgs);
...
register_post_type('eight', $eightArgs);
};
